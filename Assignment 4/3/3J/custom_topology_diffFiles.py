...
def myNetwork():
    ...
    client1.cmd("python3.8 tcp_client_new.py -p 0 -i \"1\" &")
    client2.cmd("python3.8 tcp_client_new.py -p 0 -i \"2\" &")
    client3.cmd("python3.8 tcp_client_new.py -p 0 -i \"3\" &")
    client4.cmd("python3.8 tcp_client_new.py -p 0 -i \"4\" &")
